...
public class NumberSectionDialog extends Dialog implements DialogInterface.OnDismissListener, NumberRangeSliderView.RangeSliderListener, View.OnClickListener {
    ...
    public NumberSectionDialog(Context context) {
        super(context, R.style.remind_dialog);
    }

    public static NumberSectionDialog builder(Context context) {
        return new NumberSectionDialog(context);
    }
